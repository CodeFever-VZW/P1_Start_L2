# Schrijf een programma dat informatie weergeeft over een dier in een dierentuin.
#
# De functie heeft twee parameters: dier_soort en locatie. 
# Enkel de locatie is optioneel, als die niet ingevuld wordt, wordt “onbekend” genomen.
